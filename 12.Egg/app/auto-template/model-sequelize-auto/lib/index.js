    ...
    function generateText(err) {
      ...
      async.each(
        ...
        function (table, _callback) {
          ...
          text[table] +=
            '/* indent size: ' + self.options.indentation + ' */\n\n';
          ...
          text[table] +=
            spaces + "const Model = app.model.define('" + tableName + "', {\n";
          var tableFieldComments = self.tableFieldComments[table];
          // console.log('self.tableFieldComments:', self.tableFieldComments);
          ...
          _.each(fields, function (field, i) {
            ...
            _.each(fieldAttr, function (attr, x) {
              ...
              if (attr === 'foreignKey') {
                if (isSerialKey) {
                  text[table] +=
                    spaces + spaces + spaces + 'autoIncrement: true';
                  ...
                  text[table] +=
                    ...
                    spaces +
                    "model: '" +
                    self.tables[table][field][attr].foreignSources
                      .target_table +
                    "',\n";
                  text[table] +=
                    spaces +
          ...
          if (hasadditional) {
            if (typeof self.options.additional.timestamps === 'undefined') {
              text[table] += spaces + spaces + 'timestamps: false,\n';
            }
          ...
          // associate
          text[table] +=
            spaces + 'Model.associate = function() {\n\n' + spaces + '}\n\n';
